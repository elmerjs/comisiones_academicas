...
<div class="container">
    ...
    <form action="nueva_solicitud_formacion.php" method="post">
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="numero">Documento del Profesor:</label>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="organizado_por" name="organizado_por">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="id_rector" name="id_rector">
            </div>
            <div class="col-md-6">
