...
$pdf ->Multicell(160 ,5,utf8_decode('RESOLUCIÓN VRA No.'.$resol.' DE '.$anio),0,'C');
...
if (in_array($cargo_admin, ['JEFE', 'DECANO', 'DIRECTOR'])) {
    $pdf->Multicell(160, 5, utf8_decode('Por la cual se concede comisión académica al interior a un Profesor con Cargo Académico Administrativo.'), 0, 'J');
} else {
    $pdf->Multicell(160, 5, utf8_decode('Por la cual se autoriza una comisión académica en el territorio naciona ' . $saludo . ' ' . $nombre_profesor), 0, 'J');
}
 $pdf->Ln(3);
if ($tipo_rector == 'Rector') {
    $pdf->Multicell(160, 5, utf8_decode('La VICERRECTORA ACADÉMICA DE LA UNIVERSIDAD DEL CAUCA, en uso de competencias establecidas en el Acuerdo Superior 024 de 1993 - Estatuto del Profesor de la Universidad del Cauca, principalmente conforme a lo previsto en el artículo 73, modificado por el artículo quinto del Acuerdo Superior 031 de 2020, y'), 0, 'J');
} elseif ($tipo_rector == 'Rector Encargado') {
    $pdf->Multicell(160, 5, utf8_decode('la  VICERRECTOR ACADÉMICO ENCARGADO DE LA UNIVERSIDAD DEL CAUCA, en uso de competencias establecidas en el Acuerdo Superior 024 de 1993 - Estatuto del Profesor de la Universidad del Cauca, principalmente conforme a lo previsto en el artículo 73, modificado por el artículo quinto del Acuerdo Superior 031 de 2020, y, y conforme a la ' . $resol_encargo_rector . '.'), 0, 'J');
...
$pdf ->Multicell(160 ,5,utf8_decode('La comisión solicitada'.$texto_erogaciones),0,'J');
 $pdf->Ln(3);
$pdf ->Multicell(160 ,5,utf8_decode('En mérito de lo expuesto,'),0,'J');
