...
/*
 ...
 // Añadir el título centrado
   ...
   $textRun->addText('Por la cual se concede comisión académica al exterior a un Profesor con Cargo Académico Administrativo.',  array('size' => 12));

} else {
           $textRun->addText('Por la cual se concede comisión académica al exterior ',   array('size' => 12));
...
$section->addTextBreak(1);
    ...
    $textRun = $section->addTextRun($paragraphStyle);
     ...
     $paragraphStyle = array('alignment' => Jc::BOTH, 'spaceAfter' => 150);
    $textRun = $section->addTextRun($paragraphStyle);
     $textRun->addText('Conforme el Artículo 23 del Acuerdo Superior 105 de 1993 o Estatuto General de la Universidad del Cauca, modificado por el Artículo 23 del Acuerdo Superior 025 de 2020, corresponde al Rector autorizar las comisiones académicas al exterior no conducentes a título y no superiores a un año, y presentar al Consejo Superior la solicitud de concesión de comisiones al exterior para empleados administrativos y docentes en ejercicio de cargos administrativos.',  array('size' => 12));
    
      $paragraphStyle = array('alignment' => Jc::BOTH, 'spaceAfter' => 150);
    $textRun = $section->addTextRun($paragraphStyle);
     $textRun->addText('Posteriormente, el Consejo Superior mediante Acuerdo Superior 047 de 2022, delegó en el Rector de la Universidad del Cauca, la función de autorizar las comisiones al exterior de los profesores universitarios que ejercen cargos de administración académica, recomendando la revisión del objeto, pertinencia y financiación de la comisión.',  array('size' => 12));
    ...
    $textRun = $section->addTextRun($paragraphStyle);
     $textRun->addText('Por medio de Resolución Académica N° 025 de 2023 emitida por el Consejo Académico, se delegó en la Vicerrectoría Académica la función prevista en el artículo 73 del Acuerdo 024 de 1993, relativa a la competencia para avalar las comisiones académicas al exterior de los profesores universitarios.',  array('size' => 12));
         ...
         $paragraphStyle = array('alignment' => Jc::BOTH, 'spaceAfter' => 150);
    $textRun = $section->addTextRun($paragraphStyle);
     $textRun->addText('Según lo expuesto, la concesión y autorización de comisiones académicas al exterior es competencia del Rector, con previo aval del respectivo Consejo de Facultad y de la Vicerrectoría Académica.',  array('size' => 12));
...
$textRun->addText('Mediante la Resolución Rectoral 0901 de 2023, se reglamentaron los requisitos para la autorización y concesión de las comisiones académicas al interior y al exterior del país de los profesores, conforme a la cual, además, la Rectoría y Vicerrectoría Académica con el propósito de promover los principios universitarios, los objetivos del Estatuto del Profesor en cuanto al mejoramiento del nivel educativo y, con la finalidad de salvaguardar los principios de la función administrativa, atinentes a la celeridad, economía, eficacia, eficiencia y responsabilidad, verifican la articulación de las solicitudes de comisión académica de los profesores, con el Proyecto Educativo del Programa – PEP, Proyecto Educativo Institucional – PEI y con el Plan Desarrollo Institucional – PDI 2023-2027 ',  array('size' => 12));
...
$textRun->addText('De conformidad con los documentos remitidos por el presidente del Consejo de Facultad, que soportan la solicitud de la comisión, resulta pertinente para la Universidad la asistencia ',  array('size' => 12));
...
$section->addTextBreak(1);
    ...
    $textRun->addText('ARTÍCULO PRIMERO: ', array('bold' => true,  'size' => 12));
     ...
     $textRun->addText('Conceder comisión académica al exterior, '. obtenerFechasFormateadas($fechainicio1, $fechafin1) . ', ',  array('size' => 12));
