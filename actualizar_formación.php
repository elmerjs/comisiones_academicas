    ...
    <div class="col-md-4">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="evento" name="evento" value="<?= $comision['evento'] ?>" required>
            </div>
            <div class="col-md-3">
                <label for="organizado_por">Organizado Por:</label>
                <input type="text" class="form-control" id="organizado_por" name="organizado_por" value="<?= $comision['organizado_por'] ?>" required>
            </div>
            <div class="col-md-3">
                <label for="nombre_trabajo">Nombre del Trabajo:</label>
                <input type="text" class="form-control" id="nombre_trabajo" name="nombre_trabajo" value="<?= $comision['nombre_trabajo'] ?>" >
            </div>
            <div class="col-md-3">
                <label for="justificacion">Justificación:</label>
                <input type="text" class="form-control" id="justificacion" name="justificacion" value="<?= $comision['justificacion'] ?>" required>
            </div>
        </div>
          <br>
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="estado" name="estado" value="<?= $comision['estado'] ?>" required>
            </div>
        </div>
          <br>
        <div class="row mb-3">
